...
//			//0x7002, 
//			NetBuffer data = NetBuffer.createNetBuff(SystemControl.instance.RESPONSE_KEEPALIVE, MsgType.KEEP_ALIVE);
//			String account = (String) ctx.channel().attr(AttributeKey.valueOf(Constants.ACCOUNT_KEY)).get();
//			if(account != null){
////				LogUtil.info(" send hearbeat  account :"+account);
//				Context.instance.dealIndexWithSendingMsg(data, Context.instance.getSessionTextId(ctx.channel()));
